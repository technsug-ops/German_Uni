    ...
    <div class="max-w-[1400px] mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <a href="{{ route('universities.index') }}" class="block hover:opacity-80 transition">
                ...
                <p class="text-xs text-gray-600 mt-1">🎓 {{ __('Universities') }}</p>
            </a>
            <a href="{{ route('programs.index') }}" class="block hover:opacity-80 transition">
                ...
                <p class="text-xs text-gray-600 mt-1">📚 {{ __('Programs') }}</p>
            </a>
            <a href="{{ route('professions.index') }}" class="block hover:opacity-80 transition">
                ...
                <p class="text-xs text-gray-600 mt-1">💼 {{ __('Professions') }}</p>
            </a>
            <a href="{{ route('scholarships.index') }}" class="block hover:opacity-80 transition">
                ...
                <p class="text-xs text-gray-600 mt-1">🎖️ {{ __('Scholarships') }}</p>
            </a>
            <a href="{{ route('cities.index') }}" class="block hover:opacity-80 transition">
                ...
                <p class="text-xs text-gray-600 mt-1">🏙️ {{ __('Cities') }}</p>
            </a>
            <a href="{{ route('states.index') }}" class="block hover:opacity-80 transition">
                ...
                <p class="text-xs text-gray-600 mt-1">🗺️ {{ __('States') }}</p>
            </a>
            <a href="{{ route('blog.index') }}" class="block hover:opacity-80 transition">
                ...
                <p class="text-xs text-gray-600 mt-1">📝 {{ __('Blog') }}</p>
            </a>
            <a href="{{ route('faqs.index') }}" class="block hover:opacity-80 transition">
                ...
                <p class="text-xs text-gray-600 mt-1">❓ {{ __('FAQ') }}</p>
            </a>
        </div>
...
<section class="max-w-[1400px] mx-auto px-4 py-16">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white border border-gray-200 rounded-xl p-6">
            <div class="w-12 h-12 bg-primary-100 text-primary-700 rounded-lg flex items-center justify-center text-2xl mb-3">🎓</div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6">
            <div class="w-12 h-12 bg-accent-100 text-accent-700 rounded-lg flex items-center justify-center text-2xl mb-3">🤝</div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6">
            <div class="w-12 h-12 bg-green-100 text-green-700 rounded-lg flex items-center justify-center text-2xl mb-3">🌐</div>
...
<section class="bg-gradient-to-br from-accent-50 to-white border-t border-accent-100">
    <div class="max-w-[1400px] mx-auto px-4 py-16">
        ...
        <div class="text-center mt-10">
            <a href="mailto:technsug@gmail.com?subject=AlmanyaUni%20Contribute" class="inline-block bg-accent-500 hover:bg-accent-600 text-white font-bold px-8 py-3.5 rounded-lg shadow-lg transition">
                ✉️ {{ __('Email Us — Contribute') }}
            </a>
        </div>
    </div>
</section>
...
<section class="max-w-[1400px] mx-auto px-4 py-16">
    ...
    <div class="space-y-3">
        <div class="bg-white border-l-4 border-primary-500 border-y border-r border-gray-200 rounded-r-lg p-4">
            <p class="font-semibold text-gray-900">🌍 {{ __('Multi-language support') }}</p>
            <p class="text-sm text-gray-600 mt-1">{{ __('After English & Turkish: Arabic, Farsi, German, French — to reach more students.') }}</p>
        </div>
        <div class="bg-white border-l-4 border-primary-500 border-y border-r border-gray-200 rounded-r-lg p-4">
            <p class="font-semibold text-gray-900">💼 {{ __('Career / Job integration') }}</p>
    ...
    <section class="bg-gradient-to-br from-gray-50 to-white border-t border-gray-200">
        <div class="max-w-[1400px] mx-auto px-4 py-16">
            <div class="flex items-baseline justify-between mb-6">
                <h2 class="text-2xl md:text-3xl font-extrabold text-gray-900">📝 {{ __('Latest Posts') }}</h2>
...
<section class="bg-gradient-to-br from-primary-600 to-accent-500 text-white">
    <div class="max-w-3xl mx-auto px-4 py-16 text-center">
        <h2 class="text-2xl md:text-3xl font-extrabold mb-3">📩 {{ __('Still got a question?') }}</h2>
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="mailto:technsug@gmail.com?subject=AlmanyaUni"
               class="inline-block bg-white text-primary-700 hover:bg-gray-100 font-bold px-8 py-3 rounded-lg shadow-lg transition">
                ✉️ {{ __('Send email') }}
            </a>
            <a href="{{ route('faqs.index') }}"
               class="inline-block bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-8 py-3 rounded-lg transition">
                ❓ {{ __('Browse FAQ first') }}
            </a>
        </div>
    </div>
