    ...
    <header class="bg-primary-700 text-white shadow-md sticky top-0 z-50">
        ...
        <div id="mobileMenu" class="md:hidden hidden border-t border-white/15 bg-primary-800 max-h-[85vh] overflow-y-auto">
            <div class="px-3 py-3 text-sm font-medium" x-data="{ open: null }">
                ...
                {{-- Tüm sayfalar — mobil menüde bilinçli olarak gizlenen araçlara açılan kapı.
                     Menü kısa kalsın diye 17 öğe burada görünmüyor; isteyen hepsini tek ekranda görür. --}}
                @php $__mobileHiddenCount = \App\Models\MenuPage::cached()->where('is_enabled', true)->where('hide_on_mobile', true)->count(); @endphp
                <a href="{{ route('all-pages') }}"
                   class="mt-3 flex items-center gap-2.5 px-3 py-3 rounded-lg bg-white/5 border border-white/15 text-primary-100 hover:bg-white/10 hover:text-white transition font-semibold min-h-[44px]">
                    <svg class="w-5 h-5 shrink-0 text-primary-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z"/></svg>
                    <span class="flex-1">{{ __('All pages') }}</span>
                    @if ($__mobileHiddenCount > 0)
                        <span class="text-[10px] bg-white/15 text-primary-100 px-1.5 py-0.5 rounded-full font-bold">+{{ $__mobileHiddenCount }}</span>
                    @endif
                </a>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-primary-200 text-sm">
                        ...
                        <li><a href="{{ route('news.index') }}" class="hover:text-white transition" title="{{ __('News from Germany') }}">{{ __('News from Germany') }}</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-primary-200 text-sm">
                        ...
                        <li><a href="{{ route('contact', ['type' => 'general']) }}" class="hover:text-white transition" title="{{ __('Contact') }}">{{ __('Contact') }}</a></li>
                        <li><a href="{{ route('about') }}#contribute" class="hover:text-white transition" title="{{ __('Contribute') }} — {{ __('Help improve the site') }}">{{ __('Contribute') }}</a></li>
                        <li><a href="{{ route('link-to-us') }}" class="hover:text-white transition" title="{{ __('Link to us') }} — {{ __('Press & data') }}">{{ __('Link to us') }}</a></li>
                        <li><a href="{{ route('advertise') }}" class="hover:text-white transition" title="{{ __('Advertise with us') }} — {{ __('Partnerships') }}">{{ __('Advertise with us') }}</a></li>
                        <li><a href="{{ route('all-pages') }}" class="hover:text-white transition" title="{{ __('All pages') }}">{{ __('All pages') }}</a></li>
