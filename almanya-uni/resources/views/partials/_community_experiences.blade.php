...
<section class="mt-10">
    <div class="flex items-baseline justify-between mb-4 flex-wrap gap-2">
        <h2 class="text-2xl font-bold text-gray-900 flex items-center gap-2">🌱 {{ __('Student Experiences') }}</h2>
    ...
    @if ($experiences->isEmpty())
        ...
        <div class="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl p-6 text-center">
            ...
            <a href="{{ route('contribute') }}" class="inline-block bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-lg font-semibold transition">🌱 {{ __('Share your experience') }}</a>
        </div>
    @else
                    ...
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="font-semibold text-sm text-gray-900 flex items-center gap-1.5">
                                ...
                                <span class="text-[10px]" title="{{ __('Community Contributor') }}">🌱</span>
                            </p>
