...
class MenuPageSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            ['key' => 'tools.visa-appointment', 'label' => 'Vize Randevusu', 'label_en' => 'Visa Appointment', 'label_de' => 'Visumtermin', 'icon' => '🛂', 'description' => 'iData randevu rehberi', 'badge' => 'YENİ', 'group' => 'araclar', 'sort_order' => 52],
            ['key' => 'tools.studienkolleg',   'label' => 'Studienkolleg', 'label_en' => 'Studienkolleg', 'label_de' => 'Studienkolleg', 'icon' => '🏫', 'description' => 'T/M/W/G/S kurs eşleştirme', 'group' => 'araclar', 'sort_order' => 67],
            ['key' => 'tools.deadlines',       'label' => 'Başvuru Takvimi',     'icon' => '📅', 'description' => 'Deadline + takvim', 'group' => 'araclar', 'sort_order' => 70],
            ['key' => 'tools.pathway-finder',  'label' => 'Rota Bulucu', 'label_en' => 'Pathway Finder', 'label_de' => 'Weg-Finder', 'icon' => '🗺️', 'description' => 'Sana en uygun yol', 'group' => 'araclar', 'sort_order' => 15],
            ['key' => 'tools.inspire-me',      'label' => 'Bana İlham Ver', 'label_en' => 'Inspire Me', 'label_de' => 'Inspirier mich', 'icon' => '💡', 'description' => 'İlgine göre keşfet', 'group' => 'araclar', 'sort_order' => 17],
