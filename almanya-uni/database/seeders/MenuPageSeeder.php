...
class MenuPageSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            ['key' => 'tools.career-compass',  'label' => 'Kariyer Pusulası',    'icon' => '🧭', 'description' => 'Yetenek + meslek', 'badge' => 'New', 'group' => 'araclar', 'sort_order' => 20],
            ...
            ['key' => 'tools.blocked-account', 'label' => 'Bloke Hesap Bulucu',  'icon' => '🏦', 'description' => 'Sperrkonto karşılaştır', 'badge' => 'New', 'group' => 'araclar', 'sort_order' => 60],
            ['key' => 'tools.health-insurance', 'label' => 'Sağlık Sigortası', 'label_en' => 'Health Insurance', 'label_de' => 'Krankenversicherung', 'icon' => '🩺', 'description' => 'GKV / PKV / expat karşılaştır', 'description_en' => 'GKV / PKV / expat comparison', 'description_de' => 'GKV / PKV / Expat-Vergleich', 'badge' => 'New', 'group' => 'araclar', 'sort_order' => 65],
            ['key' => 'tools.visa-appointment', 'label' => 'Vize Randevusu', 'label_en' => 'Visa Appointment', 'label_de' => 'Visumtermin', 'icon' => '🛂', 'description' => 'iData randevu rehberi', 'description_en' => 'iData appointment guide', 'description_de' => 'iData-Terminleitfaden', 'badge' => 'New', 'group' => 'araclar', 'sort_order' => 52],
            ...
            ['key' => 'events.index',       'label' => 'Etkinlikler',   'icon' => '📅', 'description' => 'Webinar · workshop · panel', 'badge' => 'New', 'group' => 'firsatlar', 'sort_order' => 30],
            ['key' => 'mentors.index',      'label' => 'Mentorlar',     'icon' => '🤝', 'description' => 'Mezunlarla 1-on-1', 'badge' => 'New', 'group' => 'firsatlar', 'sort_order' => 40],

            // ========== İÇERİK ==========
            ['key' => 'study.germany', 'label' => 'Almanya\'da Eğitim',   'icon' => '🇩🇪', 'description' => 'Neden Almanya, şehir-endüstri haritası', 'badge' => 'New', 'group' => 'icerik', 'sort_order' => 5],
