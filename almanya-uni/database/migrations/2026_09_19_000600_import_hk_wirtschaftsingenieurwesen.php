...
/**
 * DÖRDÜNCÜ PARTİ: Wirtschaftsingenieurwesen — ilk turda her iki alandan da dışlanmıştı
 * ("mühendisliğe karışmasın" diye); site onu hukuk-ekonomi sayıyor, kayıtlar oraya gidiyor.
 *
...
return new class extends Migration
{
     ...
     */
    private const FILES = [
        'hk-programs-wirtschaftsingenieurwesen.json',
    ];
