...
/**
 * İKİNCİ PARTİ: Hochschulkompass kataloğundaki MÜHENDİSLİK ve BİLİŞİM programları.
 *
 * Pilot (hukuk-ekonomi, 000300) canlıda doğrulandıktan sonra aynı desenle genişletiliyor.
...
{
    private const FILES = [
        'hk-programs-muhendislik.json',
        'hk-programs-bilisim.json',
    ];
