...
$lang = array_merge($lang, array(
	...
	'LINK'					=> 'Bağlantı',
	'LIMIT_SUBFORUMS'			=> 'Göstergeyi doğrudan alt forumlar ile sınırla',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> 'Forum açıklaması içerisinde gösterilecek olan alt forumları, geçerli forumun doğrudan altında olan alt forumlar ile sınırlar. “Açıklama içerisinde altforumları listele” seçeneği aktifken bu özellik devre dışı bırakılırsa, derinliğine bakılmaksızın tüm alt forumlar gösterilir.',
