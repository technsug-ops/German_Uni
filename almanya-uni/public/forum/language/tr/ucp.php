...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> '“%1$s” (diğer anlamda “biz”, “bize”, “bizim”, “%1$s”, “%2$s”) mesaj panosuna erişerek, aşağıdaki koşullara yasal olarak bağlı kalmayı kabul etmiş sayılıyorsunuz. Eğer aşağıdaki tüm koşullara yasal olarak bağlı kalmayı kabul etmiyorsanız, lütfen “%1$s” mesaj panosuna erişmeyin veya kullanmayın. Biz bu koşulları herhangi bir zamanda değiştirebiliriz ve bu değişiklikler hakkında sizi bilgilendirmek için her türlü çabayı gösteririz. Bununla birlikte, değişiklikler yapıldıktan sonra “%1$s” mesaj panosunu kullanmaya devam etmeniz, güncellenmiş ve/veya değiştirilmiş koşullara yasal olarak bağlı kalmayı kabul etmiş olduğunuz anlamına geldiğinden, bu belgeyi düzenli olarak gözden geçirmek sizin sorumluluğunuzdadır.
	<br><br>
	Forumlarımız “<a href="https://opensource.org/license/gpl-2-0">GNU General Public License v2</a>” (diğer anlamda “GPL” ya da “Genel Kamu Lisansı”) kapsamında yayınlanan bir mesaj panosu çözümüdür ve phpBB (diğer anlamda “onlar”, “onlara”, “onların”, “phpBB yazılımı”, “www.phpbb.com”, “phpBB Limited”, “phpBB Takımları”) tarafından desteklenmektedir. Bu yazılım <a href="https://www.phpbb.com/">www.phpbb.com</a> adresinden indirilebilir. phpBB yazılımı sadece internet tabanlı tartışmaları kolaylaştırmak içindir; phpBB Limited, bu sitede izin verilen veya izin verilmeyen içerik ya da davranışlardan sorumlu değildir. phpBB hakkında daha fazla bilgi için, lütfen bu adrese bakın: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
	Ülkenizin yasalarına, “%1$s” mesaj panosunun barındırıldığı ülkenin yasalarına veya uluslararası hukuka göre yasa dışı olan herhangi bir küfürlü, müstehcen, kaba, iftira niteliğinde, nefret dolu, tehdit edici, cinsel içerikli veya başka türlü yasa dışı materyaller yayınlamayacağınızı kabul edersiniz. Bunları yapmanız veya dikkate almamanız durumunda derhal ve kalıcı olarak mesaj panosundan yasaklanabilirsiniz ve tarafımızca gerekli görüldüğü takdirde İnternet Servis Sağlayıcınıza bildirimde bulunulabilir. Bu koşulların uygulanmasına yardımcı olmak için tüm gönderilerin IP adresi kaydedilir.
	<br><br>
	“%1$s” mesaj panosunda, tamamen kendi takdirimize bağlı olarak herhangi bir başlığı kaldırma, düzenleme, taşıma veya kapatma hakkımızın saklı olduğunu kabul ediyorsunuz. Bir kullanıcı olarak, her girdiğiniz bilginin bir veritabanı içerisinde saklanabileceğini kabul edersiniz. Bu bilgiler sizin izniniz olmadan hiçbir üçüncü tarafa açıklanmayacak olsa da, verilerin tehlikeye atılmasına yol açabilecek herhangi bir siber saldırı girişiminden ne “%1$s” ne de phpBB sorumlu tutulamaz.	
	',

	'PRIVACY_POLICY'		=> 'Bu ilkeler, “%1$s” ve bağlı şirketlerinin (diğer anlamda “biz”, “bize”, “bizim”, “%1$s”, “%2$s”) ve phpBB (diğer anlamda “onlar”, “onların”, “phpBB yazılımı”, “www.phpbb.com”, “phpBB Limited”, “phpBB Ekipleri”) yazılımının bu siteyi kullanımınız sırasında toplanan bilgileri (diğer anlamda “bilgileriniz”) nasıl kullandığını ayrıntılı olarak açıklamaktadır.
	<br><br>
	Bilgileriniz iki şekilde toplanır. “%1$s” sitesini ziyaret ettiğinizde, phpBB yazılımı birkaç çerez oluşturur. Çerezler, web tarayıcınızın geçici dosyalarında saklanan küçük metin dosyalarıdır. İlk iki çerez, phpBB yazılımı tarafından otomatik olarak atanan bir kullanıcı tanımlayıcısı (diğer anlamda “user-id”) ve anonim bir oturum tanımlayıcısı (diğer anlamda “session-id”) içerir. “%1$s” içindeki konuları gezdiğinizde ise üçüncü bir çerez oluşturulur. Bu çerez, hangi konuları okuduğunuz hakkında bilgi depolayarak kullanıcı deneyiminizi iyileştirir.
	<br><br>
	Ayrıca “%1$s” mesaj panosunu dolaşırken phpBB yazılımının dışında da çerezler oluşturabiliriz. Bunlar, bu belgenin kapsamı dışındaki yalnızca phpBB yazılımı tarafından oluşturulan çerezlerdir.
 	<br><br>
	Bilgilerinizi toplamanın ikinci yolu ise bize gönderdiğiniz verilerdir. Bu veriler şunları içerebilir ve bunlarla sınırlı değildir: misafir kullanıcı olarak mesaj göndermek (diğer anlamda “misafir mesajları”), “%1$s” mesaj panosuna kayıt olmak (diğer anlamda “hesabınız”) ve kayıt olup giriş yaptıktan sonra tarafınızdan gönderilen mesajlar (diğer anlamda “mesajlarınız”).	
	<br><br>
	Hesabınız en azından şunları içerecektir: benzersiz bir kullanıcı adı (diğer anlamda “kullanıcı adınız”), hesabınıza giriş yapmak için kullanacağınız kişisel bir şifre (diğer anlamda “şifreniz”), geçerli bir e-posta adresi (diğer anlamda “e-posta adresiniz”). “%1$s” mesaj panosundaki hesap bilgileriniz, sunucumuzu barındıran ülkedeki geçerli veri koruma yasalarıyla korunmaktadır. Kayıt işlemi sırasında istenen kullanıcı adınız, şifreniz ve e-posta adresiniz dışındaki hangi bilginin gerekli ya da isteğe bağlı olacağı “%1$s” mesaj panosunun takdirine bağlıdır. Yine de her durumda, hesabınızdaki hangi bilgilerin herkes tarafından görüntüleneceğini seçebilirsiniz. Ayrıca, phpBB yazılımından otomatik olarak oluşturulan e-postaları alıp almamayı da seçebilirsiniz.	
	<br><br>
	Şifreniz, güvenliği sağlamak için tek yönlü bir karma kod olarak saklanır. Ancak, aynı şifreyi birden fazla web sitesinde tekrar kullanmamanızı öneririz. Şifreniz, “%1$s” mesaj panosundaki hesabınızın anahtarıdır, bu nedenle lütfen şifrenizi güvende tutun. Hiçbir koşulda, “%1$s”, phpBB veya herhangi bir üçüncü taraf ile bağlantılı hiç kimse sizden şifrenizi yasal olarak istemeyecektir. Şifrenizi unutursanız, phpBB yazılımının sağladığı “Şifremi unuttum” özelliğini kullanabilirsiniz. Bu işlem, kullanıcı adınızı ve e-posta adresinizi girmenizi gerektirir; ardından phpBB yazılımı, hesabınıza tekrar erişim sağlamanız için yeni bir parola oluşturacaktır.	
	',
));
